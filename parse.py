...
#   command='cd /home/simon/stanford-parser-full-2016-10-31; java -mx150m -cp "*:" edu.stanford.nlp.parser.lexparser.LexicalizedParser -outputFormat "typedDependencies" edu/stanford/nlp/models/lexparser/englishPCFG.ser.gz /tmp/autocorpus/english-onesent.txt > /tmp/autocorpus/english-onesent.txt.out'
    print(command)
    system(command)
